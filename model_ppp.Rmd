...
```{r}
fit1psa <- gam(WISC ~ s(P1) + M_IQ  + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE, data = mn)
fit2psa <- gam(WISC ~ s(P2) + M_IQ  + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE, data = mn)
fit3psa <- gam(WISC ~ P1 + s(P2) + M_IQ  + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE, data = mn)
...
```{r}
fit1ia <- gam(WISC ~ s(P1, by = SEX) + M_IQ + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn)
fit2ia <- gam(WISC ~ s(P2, by = SEX) + M_IQ + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn)
...
```{r}
fit1sia <- gam(WISC ~ s(P1, by = SEX) + M_IQ + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn, subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
fit2sia <- gam(WISC ~ s(P2, by = SEX) + M_IQ + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn, subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
fit3sia <- gam(WISC ~ P1 + s(P2, by = SEX) + M_IQ + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn, subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
...
fit3lia <- lm(WISC ~ P1 + P2 + SEX*P2  + SEX*P1 + SEX + M_IQ + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn, x = TRUE,
               subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
summary(fit3lia)
```
...
fit3fa <- lm(WISC ~ P1 + P2 + M_IQ + ALCOHOL + M_EDU + 
               HOME_SCORE, data = mn, x = TRUE,
             subset = (SEX == "Female" & P2 < mean(mn$P2) + 5*sd(mn$P2) ))
summary(fit3fa)
```
