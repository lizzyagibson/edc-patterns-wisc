...
**All data**
```{r}
fit_fs1 <- lm(WISC ~ P2 + SEX + P1 + SEX*P2 +  
            M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE, data = mn)

predFS1 <- as_tibble(predict(fit_fs1, std.error = TRUE))

mn_subset1 = mn %>% dplyr::select(WISC, P1, P2, SEX, M_IQ, ETH, ALCOHOL, M_EDU, 
...
```{r}
fit_fs <- lm(WISC ~ P2 + SEX + P1 + SEX*P2 +  
            M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE, data = mn, 
...
mn_subset = mn %>% dplyr::select(WISC, P1, P2, SEX, M_IQ, ETH, ALCOHOL, M_EDU, 
                                 MARITAL_STATUS, HOME_SCORE) %>% drop_na() %>% 
            filter(P2 < mean(mn$P2) + 5*sd(mn$P2) )
...
```{r}
fit1a <- lm(WISC ~ P1 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE + SEX, data = mn)
fit2a <- lm(WISC ~ P2 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE + SEX, data = mn)
fit3a <- lm(WISC ~ P1 + P2 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE + SEX, data = mn)
...
```{r}
fit1psa <- gam(WISC ~ s(P1) + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE + SEX, data = mn)
fit2psa <- gam(WISC ~ s(P2) + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE + SEX, data = mn)
fit3psa <- gam(WISC ~ P1 + s(P2) + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + HOME_SCORE + SEX, data = mn)
...
```{r}
fit1ia <- gam(WISC ~ s(P1, by = SEX) + M_IQ + ETH + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn)
fit2ia <- gam(WISC ~ s(P2, by = SEX) + M_IQ + ETH + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn)
fit3ia <- gam(WISC ~ P1 + s(P2, by = SEX) + M_IQ + ETH + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn)
...
```{r}
fit1sia <- gam(WISC ~ s(P1, by = SEX) + M_IQ + ETH + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn, subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
fit2sia <- gam(WISC ~ s(P2, by = SEX) + M_IQ + ETH + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn, subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
fit3sia <- gam(WISC ~ P1 + s(P2, by = SEX) + M_IQ + ETH + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn, subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
...
```{r}
fit1lia <- lm(WISC ~ P1 + SEX*P1 + SEX + M_IQ + ETH + ALCOHOL + M_EDU + 
              MARITAL_STATUS + HOME_SCORE, data = mn, x = TRUE,
             subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
#get_output(fit1lia)

fit2lia <- lm(WISC ~ P2 + SEX*P2 + SEX + M_IQ + ETH + ALCOHOL + M_EDU + 
              MARITAL_STATUS + HOME_SCORE, data = mn, x = TRUE,
             subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
#get_output(fit2lia)

fit3lia <- lm(WISC ~ P1 + P2 + SEX*P2  + SEX*P1 + SEX + M_IQ + ETH + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn, x = TRUE,
               subset = (P2 < mean(mn$P2) + 5*sd(mn$P2) ))
get_output(fit3lia)
```
...
##### Female
```{r}
fit1fa <- lm(WISC ~ P1 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + 
               HOME_SCORE, data = mn, x = TRUE,
             subset = (SEX == "Female" & P2 < mean(mn$P2) + 5*sd(mn$P2) ))
#get_output(fit1fa)

fit2fa <- lm(WISC ~ P2 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + 
               HOME_SCORE, data = mn, x = TRUE,
             subset = (SEX == "Female" & P2 < mean(mn$P2) + 5*sd(mn$P2) ))
#get_output(fit2fa)

fit3fa <- lm(WISC ~ P1 + P2 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + 
               HOME_SCORE, data = mn, x = TRUE,
             subset = (SEX == "Female" & P2 < mean(mn$P2) + 5*sd(mn$P2) ))
get_output(fit3fa)
```
...
```{r}
summary(lm(WISC ~ P1 + P2 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + M_AGE + 
               HOME_SCORE, data = mn, x = TRUE,
             subset = (SEX == "Female" & P2 < mean(mn$P2) + 5*sd(mn$P2) )))
```
...
##### Male
```{r}
fit1ma <- lm(WISC ~ P1 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + 
               HOME_SCORE, data = mn, x = TRUE,
             subset = (SEX == "Male" & P2 < mean(mn$P2) + 5*sd(mn$P2) ))
#get_output(fit1ma)

fit2ma <- lm(WISC ~ P2 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + 
               HOME_SCORE, data = mn, x = TRUE,
             subset = (SEX == "Male" & P2 < mean(mn$P2) + 5*sd(mn$P2) ))
#get_output(fit2ma)

fit3ma <- lm(WISC ~ P1 + P2 + M_IQ + ETH + ALCOHOL + M_EDU + MARITAL_STATUS + 
               HOME_SCORE, data = mn, x = TRUE,
             subset = (SEX == "Male" & P2 < mean(mn$P2) + 5*sd(mn$P2) ))
get_output(fit3ma)
```
...
mn_subsetm = mn %>% dplyr::select(WISC, P1, P2, SEX, M_IQ, ETH, ALCOHOL, M_EDU, 
                                 MARITAL_STATUS, HOME_SCORE) %>% drop_na() %>% 
              filter(SEX == "Male" & P2 < mean(mn$P2) + 5*sd(mn$P2) ) %>% 
              mutate(model = "Main Model")
mn_subsetf = mn %>% dplyr::select(WISC, P1, P2, SEX, M_IQ, ETH, ALCOHOL, M_EDU, 
                                 MARITAL_STATUS, HOME_SCORE) %>% drop_na() %>% 
...
main = bind_rows(male_pred, female_pred) %>% 
  dplyr::select(-c(M_IQ, ETH, ALCOHOL, M_EDU, MARITAL_STATUS, HOME_SCORE)) %>% 
  pivot_longer(P1:P2)
...
```{r}
fit_sense <- gam(WISC ~ P1 + s(P2, by = SEX) + M_IQ + ETH + ALCOHOL + M_EDU + 
                MARITAL_STATUS + HOME_SCORE, data = mn)
