...
%
% Auto-generated by MATLAB on 27-Feb-2021 14:18:41
...
% Import the data
edc = readtable("/Users/lizzy/ppp_patterns/Data/ppp_dat.csv", opts);
...
[EWA, EH, varH, alphaH, betaH, alphaW, betaW, ...
    alphaA, betaA, varWA, finalscore, final_iter, init_seed_struct] = BN2MF(dataNorm, 1000);
toc()
% Final Iter Score: 2609.7477 , 2651.4491
% ~5.4min
...
save("/Users/lizzy/ppp_patterns/Data/mn2_WA_dist.mat", 'WA_scaled');
